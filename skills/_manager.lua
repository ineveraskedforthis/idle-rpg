...
---@field update fun(vfx: VFX, stage: Stage, player: PlayerState, dt: number, model: ActorModelState, model_description: ActorModelDescription, skip_casting : boolean)
---@field activation_range fun(player: PlayerState, model: ActorModelDescription) : number
